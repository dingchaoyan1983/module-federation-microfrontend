...
const Provider = createLazyComponent({
  loader: () => import('hostApp/HostProvider'),
  instance: getInstance(),
  loading: <div>Loading...</div>,
  fallback: <div>Failed to load provider</div>,
});
const Subapp1Component = createLazyComponent({
  loader: () => import('subapp1/Subapp1Component'),
  instance: getInstance(),
  loading: <div>Loading...</div>,
  fallback: <div>Failed to load provider</div>,
});
const Subapp1Button = createLazyComponent({
  loader: () => import('subapp1/Button'),
  instance: getInstance(),
  loading: <div>Loading...</div>,
  fallback: <div>Failed to load provider</div>,
  export: "Button"
